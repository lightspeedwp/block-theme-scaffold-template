...
| `{{theme_slug}}-sections` | Theme-specific sections |
 ...
 * Slug: {{theme_slug}}/coming-soon-content
 * Categories: {{theme_slug}}-sections
...
```php
<!-- Inline text -->
<h2><?php esc_html_e( 'Welcome to Our Site', '{{theme_slug}}' ); ?></h2>

<!-- Attribute values -->
<a href="#" aria-label="<?php esc_attr_e( 'Learn more about our services', '{{theme_slug}}' ); ?>">

<!-- With variables -->
<p><?php echo esc_html__( 'Read more', '{{theme_slug}}' ); ?></p>
```
...
```php
<!-- Navigation -->
<nav aria-label="<?php esc_attr_e( 'Main navigation', '{{theme_slug}}' ); ?>">

<!-- Pagination -->
<nav aria-label="<?php esc_attr_e( 'Pagination', '{{theme_slug}}' ); ?>">

<!-- Post metadata -->
<div aria-label="<?php esc_attr_e( 'Post metadata', '{{theme_slug}}' ); ?>">
```
