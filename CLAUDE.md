...
# Claude AI Usage for Block Theme Scaffold

This repository supports Claude for advanced code generation, refactoring, and documentation in WordPress block theme development. Use Claude for:
