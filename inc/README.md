...
- `{{theme_slug}}_register_block_patterns()` - Registers pattern categories and patterns
...
register_block_pattern(
    ...
    array(
        ...
        'description' => __( 'A hero section with heading and call to action.', '{{theme_slug}}' ),
        'content'     => '<!-- wp:pattern {"slug":"{{theme_slug}}/hero"} /-->',
        'categories'  => array( '{{theme_slug}}-patterns' ),
    )
);
```
...
- `{{theme_slug}}_register_block_styles()` - Registers block style variations
